...
if __name__ == "__main__":
    main()
    # 启动server
    # python -m vllm.entrypoints.openai.api_server --model Qwen2___5-3B-Instruct --port 8000
    # 启动界面
    # streamlit run o1-reasoning_vllm.py --server.address 127.0.0.1 --server.port 6006